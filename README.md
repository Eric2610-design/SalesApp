...
## Doppelte Apps beheben
Wenn auf dem Homescreen Apps doppelt auftauchen, wurde die App-Registry mehrfach installiert (meist ohne UNIQUE-Index auf `apps.slug`).

1. In Supabase SQL Editor: `supabase/cleanup_dedupe_apps.sql` ausführen
2. Danach sollten keine Duplikate mehr angezeigt werden.
