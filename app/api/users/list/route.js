...
export async function GET() {
  try {
    ...
    // territories in a separate query (avoids schema-cache relationship issues)
    ...
    const merged = (users || []).map((u) => ({ ...u, territories: territoriesByUser[u.user_id] || [] }));
