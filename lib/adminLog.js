...
export function undoRestorePageConfig(key, previousRow) {
  return { type: 'restore_page_config', key, previous_row: previousRow || null };
}

export function undoRestoreManufacturer(key, previousRow) {
  return { type: 'restore_manufacturer', key, previous_row: previousRow || null };
}

export function undoRestoreBuyingGroup(key, previousRow) {
  return { type: 'restore_buying_group', key, previous_row: previousRow || null };
}
